...
export const UI: Record<Locale, Record<string, string>> = {
	en: {
		...
		'admin.search': 'Search',
		'admin.searchYouTube': 'Search YouTube — artist, track, anything',
		'admin.searching': 'Searching YouTube…',
		'admin.liveStream': '● LIVE',
		'admin.cannotGrabLive': 'Live — cannot grab',
		'admin.saveMp3': 'MP3',
		'admin.saveMp4': 'MP4',
		'admin.saveMp3Title': 'Download the audio as a 320 kbps MP3, straight to this device',
		'admin.saveMp4Title': 'Download the video as an MP4, best quality up to 1080p',
		'admin.preparing': 'Preparing…',
		'admin.downloadNote':
			'MP3 and MP4 download straight to this device and are never stored on the site. MP4 is merged on the server first, so a long video can take a minute before the save dialog appears; video is capped at 1080p.',
		'admin.searchHelp': 'Press Enter to search.',
		...
		'admin.owner': 'Owner',
		'admin.myLibrary': 'My library',
		'admin.unowned': 'Unassigned',
		'admin.all': 'All',
	...
	es: {
		...
		'admin.search': 'Buscar',
		'admin.searchYouTube': 'Buscar en YouTube — artista, canción, lo que sea',
		'admin.searching': 'Buscando en YouTube…',
		'admin.liveStream': '● EN VIVO',
		'admin.cannotGrabLive': 'En vivo — no se puede',
		'admin.saveMp3': 'MP3',
		'admin.saveMp4': 'MP4',
		'admin.saveMp3Title': 'Descargar el audio como MP3 de 320 kbps, directo a este dispositivo',
		'admin.saveMp4Title': 'Descargar el video como MP4, mejor calidad hasta 1080p',
		'admin.preparing': 'Preparando…',
		'admin.downloadNote':
			'MP3 y MP4 se descargan directo a este dispositivo y nunca se guardan en el sitio. El MP4 se une en el servidor primero, así que un video largo puede tardar un minuto antes de que aparezca el diálogo de guardado; el video llega hasta 1080p.',
		'admin.searchHelp': 'Pulsa Enter para buscar.',
		...
		'admin.owner': 'Dueño',
		'admin.myLibrary': 'Mi biblioteca',
		'admin.unowned': 'Sin dueño',
		'admin.all': 'Todas',
